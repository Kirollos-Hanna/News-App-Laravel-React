...
/* unused harmony export validateEmptyInput */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Grid_vue__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__store_favoritesGridStore_js__ = __webpack_require__(14);



Nova.booting(function (Vue, router, store) {
  __WEBPACK_IMPORTED_MODULE_1__store_favoritesGridStore_js__["a" /* default */]['namespaced'] = true;
  store.registerModule('favoritesGridStore', __WEBPACK_IMPORTED_MODULE_1__store_favoritesGridStore_js__["a" /* default */]);

  Vue.component('grid', __WEBPACK_IMPORTED_MODULE_0__components_Grid_vue___default.a);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-92d6219e", Component.options)
  } else {
    hotAPI.reload("data-v-92d6219e", Component.options)
  }
...
var update = __webpack_require__(2)("17b55bf2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-92d6219e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Grid.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-92d6219e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Grid.vue");
...
// module
exports.push([module.i, ".grid{\n    margin: 10px auto;\n    width: 100%;\n    height: auto;\n    border-collapse: collapse;\n    text-align: center;\n    background-color: white;\n    overflow-y: scroll;\n    border-radius: 10px;\n}\n\n.grid-head {\n    background-color: #eaeaff;\n    font-weight: bold;\n}\n\n.grid-head, .grid-body{\n    width: 100%;\n}\n\n.grid-head tr, .grid-body tr{\n    border-bottom: 1px solid black;\n}\n\n.grid-head tr:last-child, .grid-body tr:last-child{\n    border-right: none;\n}\n\n.grid-head tr{\n    padding: 30px 0;\n    border-bottom: 3px solid black;\n}\n\n.grid td{\n    padding: 8px;\n    /* border-right: 1px solid black; */\n}\n\ntd:last-child, .grid-body tr:last-child{\n    border-bottom: none;\n}\n\n.grid tr{\n    height: 40px;\n}\n\n.grid tr:nth-child(2n){\n    background-color: #f7f7f7;\n}\n\n.no-val-error{\n    color: red;\n}\n\n.soft-deleted{\n    background-color: #808080 !important;\n}", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getEmail: function getEmail(name) {
      var elm = this.emails.find(function (elm) {
...
var render = function() {
  ...
  return _c("table", { staticClass: "grid" }, [
    _vm._m(0),
    _vm._v(" "),
    _c(
      "tbody",
      { staticClass: "grid-body" },
      _vm._l(_vm.favorites, function(favorite) {
        return _c(
          "tr",
          { key: favorite.id, class: { "soft-deleted": favorite.softDeleted } },
          [
            _c("td", [_vm._v(_vm._s(favorite.id))]),
            _vm._v(" "),
            _c("td", [
              _vm._v("\n        " + _vm._s(favorite.title) + "\n        "),
              favorite.softDeleted
                ? _c("span", [_vm._v("(Deleted)")])
                : _vm._e()
            ]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(favorite.source))]),
            _vm._v(" "),
            favorite.author
              ? _c("td", { attrs: { c: "" } }, [
                  _vm._v(_vm._s(favorite.author))
                ])
              : _c("td", { staticClass: "no-val-error" }, [
                  _vm._v("Author is not found")
                ]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(favorite.posting_date))]),
            _vm._v(" "),
            favorite.created_at
              ? _c("td", [_vm._v(_vm._s(favorite.created_at))])
              : _c("td", { staticClass: "no-val-error" }, [
                  _vm._v("Created At is not found")
                ]),
            _vm._v(" "),
            favorite.user
              ? _c("td", [_vm._v(_vm._s(favorite.user))])
              : _vm._e(),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(_vm.getEmail(favorite.user)))]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(favorite.posted ? "true" : "false"))])
          ]
        )
      }),
      0
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("thead", { staticClass: "grid-head" }, [
      _c("tr", [
        _c("td", [_vm._v("Id")]),
        _vm._v(" "),
        _c("td", [_vm._v("Article Title")]),
        _vm._v(" "),
        _c("td", [_vm._v("Article Source")]),
        _vm._v(" "),
        _c("td", [_vm._v("Author")]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-92d6219e", module.exports)
  }
}
...
var mutations = {
    setFavorites: function setFavorites(state, favorites) {
        state.favorites = favorites;
    },
    setUsers: function setUsers(state, users) {
        state.users = users;
    },
    setFilterPosted: function setFilterPosted(state, filterPosted) {
...
var actions = {
    setFavorites: function setFavorites(context, filterPosted) {
        var filter = filterPosted ? filterPosted.target.value : "";
        var str = '[{"class":"App\\\\Nova\\\\Filters\\\\FilterFavoriteByUser","value":""},{"class":"App\\\\Nova\\\\Filters\\\\DateAfterFilter","value":""},{"class":"App\\\\Nova\\\\Filters\\\\DateBeforeFilter","value":""},{"class":"App\\\\Nova\\\\Filters\\\\FilterPosted","value":"' + filter + '"}]';
        var hashedStr = btoa(str);
        Nova.request().get("/nova-api/favorites?filters=" + hashedStr + "&trashed=with").then(function (res) {
            var favorites = [];
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _extends({
    ...
    filterPostedItems: function filterPostedItems(filterPosted) {
      this.setFilterPosted(filterPosted);
      this.setFavorites(filterPosted);
    }
  }, Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["a" /* mapActions */])({
  ...
  computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["b" /* mapState */])({
    favorites: function favorites(state) {
      return state.favoritesGridStore.favorites;
    },
    emails: function emails(state) {
      return state.favoritesGridStore.users;
    },
    filterPosted: function filterPosted(state) {
      return state.favoritesGridStore.filterPosted;
    }
  }))
});
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", [_vm._v("Favorites Grid")]),
      _vm._v(" "),
      _c("div", [
        _c(
          "select",
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.filterPosted,
                expression: "filterPosted"
              }
            ],
            on: {
              change: [
                function($event) {
                  ...
                  _vm.filterPosted = $event.target.multiple
                    ? $$selectedVal
                    : $$selectedVal[0]
                },
                _vm.setFavorites
          ...
          [
            ...
            _vm._v(" "),
            _c("option", { attrs: { value: "0" } }, [_vm._v("Not Posted")]),
            _vm._v(" "),
            _c("option", { attrs: { value: "1" } }, [_vm._v("Posted")])
          ]
        ),
        _vm._v(" "),
        _c(
          "button",
          {
            staticClass: "create-favorites-button",
      ...
      _vm._v(" "),
      _c("grid", { attrs: { favorites: _vm.favorites, emails: _vm.emails } })
    ],
    1
  )
}
