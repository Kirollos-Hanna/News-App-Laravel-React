...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ComponentsTool_resources_js_helpers_js__ = __webpack_require__(14);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    submitForm: function submitForm(event) {
      ...
      this.errorTitle = Object(__WEBPACK_IMPORTED_MODULE_1__ComponentsTool_resources_js_helpers_js__["b" /* validateEmptyInput */])(this.inputTitle);
      this.errorSource = Object(__WEBPACK_IMPORTED_MODULE_1__ComponentsTool_resources_js_helpers_js__["b" /* validateEmptyInput */])(this.inputSource);
      this.errorUser = Object(__WEBPACK_IMPORTED_MODULE_1__ComponentsTool_resources_js_helpers_js__["b" /* validateEmptyInput */])(this.inputUser);
      this.errorPostDate = Object(__WEBPACK_IMPORTED_MODULE_1__ComponentsTool_resources_js_helpers_js__["b" /* validateEmptyInput */])(this.inputPostDate);

      if (!Object(__WEBPACK_IMPORTED_MODULE_1__ComponentsTool_resources_js_helpers_js__["c" /* validateUrl */])(this.inputSource)) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", Nova.request().get("/nova-api/users").then(function (res) {
                  var arrayOfFields = Object(__WEBPACK_IMPORTED_MODULE_1__ComponentsTool_resources_js_helpers_js__["a" /* parseResponse */])(res);
                  var users = [];
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "input-container" }, [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "input-container-background" }, [
        _c("div", { staticClass: "field-container" }, [
          _c(
            ...
            [
              _c("label-text", {
                attrs: { label: _vm.title, isRequired: true }
              })
            ],
            1
          ),
        ...
        _c("div", { staticClass: "field-container" }, [
          _c(
            ...
            [
              _c("label-text", {
                attrs: { label: _vm.author, isRequired: false }
              })
            ],
            1
          ),
        ...
        _c("div", { staticClass: "field-container" }, [
          _c(
            ...
            [
              _c("label-text", {
                attrs: { label: _vm.source, isRequired: true }
              })
            ],
            1
          ),
          ...
          _c(
            ...
            [
              ...
              _c("error-label", {
                attrs: {
                  label: _vm.source,
                  errorType: _vm.emptyAndInvalidError,
                  emptyError: _vm.errorSource,
                  validationError: _vm.validationErrorSource
                }
              })
            ],
        ...
        _c("div", { staticClass: "field-container" }, [
          ...
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("error-label", {
                attrs: { label: _vm.postDate, emptyError: _vm.errorPostDate }
              })
            ],
            1
          )
        ...
        _c("div", { staticClass: "field-container" }, [
          _c(
            ...
            { staticClass: "label-spacing" },
            [
              _c("label-text", { attrs: { label: _vm.user, isRequired: true } })
            ],
            1
          ),
          _vm._v(" "),
            ...
            [
              _c("dropdown-input", {
                attrs: {
                  ...
                  input: _vm.inputUser,
                  changeInput: _vm.changeInput,
                  getOptions: _vm.getUsers,
                  error: _vm.errorUser
                }
              }),
              _vm._v(" "),
              _c("error-label", {
                attrs: { label: _vm.user, emptyError: _vm.errorUser }
              })
            ],
            1
          )
