...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store_favoritesStore_js__ = __webpack_require__(46);
...
Nova.booting(function (Vue, router, store) {
  __WEBPACK_IMPORTED_MODULE_3__store_favoritesStore_js__["a" /* default */]['namespaced'] = true;
  store.registerModule('createFavorites', __WEBPACK_IMPORTED_MODULE_3__store_favoritesStore_js__["a" /* default */]);
...
var mutations = {
    setUser: function setUser(state, users) {
        state.users = users;
    },
    setInputTitle: function setInputTitle(state, title) {
        state.inputTitle = title;
    },
    setInputSource: function setInputSource(state, source) {
        state.inputSource = source;
    },
    setInputUser: function setInputUser(state, user) {
        state.inputUser = user;
    },
    setInputPostDate: function setInputPostDate(state, postDate) {
        state.inputPostDate = postDate;
    },
    setInputAuthor: function setInputAuthor(state, author) {
        state.inputAuthor = author;
    },
    setInputPosted: function setInputPosted(state, posted) {
        state.inputPosted = posted;
    },
    setErrorTitle: function setErrorTitle(state, errorTitle) {
        state.errorTitle = errorTitle;
    },
    setErrorSource: function setErrorSource(state, errorSource) {
        state.errorSource = errorSource;
    },
    setErrorUser: function setErrorUser(state, errorUser) {
        state.errorUser = errorUser;
    },
    setErrorPostDate: function setErrorPostDate(state, errorPostDate) {
        state.errorPostDate = errorPostDate;
    },
    setValidationErrorSource: function setValidationErrorSource(state, validationErrorSource) {
        state.validationErrorSource = validationErrorSource;
    },
    setErrorSameTitle: function setErrorSameTitle(state, errorSameTitle) {
        state.errorSameTitle = errorSameTitle;
    },
    clearInputsAndErrors: function clearInputsAndErrors(state) {
        state.inputTitle = "";
        state.inputSource = "";
        state.inputUser = "";
        state.inputPostDate = "";
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["c" /* mapState */])({
    // Input types
    textInput: function textInput(state) {
      return state.createFavorites.textInput;
    },
    urlInput: function urlInput(state) {
      return state.createFavorites.urlInput;
    },
    dateInput: function dateInput(state) {
      return state.createFavorites.dateInput;
    },
    title: function title(state) {
      return state.createFavorites.title;
    },
    source: function source(state) {
      return state.createFavorites.source;
    },
    postDate: function postDate(state) {
      return state.createFavorites.postDate;
    },
    author: function author(state) {
      return state.createFavorites.author;
    },
    user: function user(state) {
      return state.createFavorites.user;
    },
    posted: function posted(state) {
      return state.createFavorites.posted;
    },

    // Input values
    inputTitle: function inputTitle(state) {
      return state.createFavorites.inputTitle;
    },
    inputSource: function inputSource(state) {
      return state.createFavorites.inputSource;
    },
    inputUser: function inputUser(state) {
      return state.createFavorites.inputUser;
    },
    inputPostDate: function inputPostDate(state) {
      return state.createFavorites.inputPostDate;
    },
    inputAuthor: function inputAuthor(state) {
      return state.createFavorites.inputAuthor;
    },
    inputPosted: function inputPosted(state) {
      return state.createFavorites.inputPosted;
    },

    // Dropdown options value
    users: function users(state) {
      return state.createFavorites.users;
    },

    // Errors
    errorTitle: function errorTitle(state) {
      return state.createFavorites.errorTitle;
    },
    errorSource: function errorSource(state) {
      return state.createFavorites.errorSource;
    },
    errorUser: function errorUser(state) {
      return state.createFavorites.errorUser;
    },
    errorPostDate: function errorPostDate(state) {
      return state.createFavorites.errorPostDate;
    },
    validationErrorSource: function validationErrorSource(state) {
      return state.createFavorites.validationErrorSource;
    },
    errorSameTitle: function errorSameTitle(state) {
      return state.createFavorites.errorSameTitle;
    }
  })),
  methods: _extends({
    submitForm: function submitForm(event) {
      ...
      this.setErrorTitle(Object(__WEBPACK_IMPORTED_MODULE_0__helpers_js__["b" /* validateEmptyInput */])(this.inputTitle));
      this.setErrorSource(Object(__WEBPACK_IMPORTED_MODULE_0__helpers_js__["b" /* validateEmptyInput */])(this.inputSource));
      this.setErrorUser(Object(__WEBPACK_IMPORTED_MODULE_0__helpers_js__["b" /* validateEmptyInput */])(this.inputUser));
      this.setErrorPostDate(Object(__WEBPACK_IMPORTED_MODULE_0__helpers_js__["b" /* validateEmptyInput */])(this.inputPostDate));
  ...
  }), Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* mapActions */])({
        ...
        [
          ...
          _c("div", { staticClass: "field-container" }, [
            _c(
              ...
              [
                _c("label-text", {
                  attrs: { label: "Posted", isRequired: false }
                })
              ],
              1
            ),
            ...
            _c("div", { staticClass: "input-spacing" }, [
              _c("input", {
                ...
                staticClass: "checkbox-input input-decoration",
                attrs: { type: "checkbox", placeholder: "Posted" },
                domProps: {
                ...
                on: {
                  change: [
                    ...
                    function($event) {
                      return _vm.changeInput(_vm.checked, "Posted")
                    }
                  ]
                }
              })
